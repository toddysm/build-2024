...
kubectl run demo-app --image-pull-policy='Always' --image=acrbuild2024.azurecr.io/flaskapp:1.0-unsigned
kubectl get pods
...
kubectl run demo-app --image-pull-policy='Always' --image=ghcr.io/payalmahesh/flaskapp:1.0